...
public final class EncryptionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<service.EncryptRequest,
      service.EncryptResponse> getEncryptMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "encrypt",
      requestType = service.EncryptRequest.class,
      responseType = service.EncryptResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<service.EncryptRequest,
      service.EncryptResponse> getEncryptMethod() {
    io.grpc.MethodDescriptor<service.EncryptRequest, service.EncryptResponse> getEncryptMethod;
      ...
      synchronized (EncryptionGrpc.class) {
        if ((getEncryptMethod = EncryptionGrpc.getEncryptMethod) == null) {
          EncryptionGrpc.getEncryptMethod = getEncryptMethod =
              io.grpc.MethodDescriptor.<service.EncryptRequest, service.EncryptResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "encrypt"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  service.EncryptRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  service.EncryptResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<service.DecryptRequest,
      service.DecryptResponse> getDecryptMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "decrypt",
      requestType = service.DecryptRequest.class,
      responseType = service.DecryptResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<service.DecryptRequest,
      service.DecryptResponse> getDecryptMethod() {
    io.grpc.MethodDescriptor<service.DecryptRequest, service.DecryptResponse> getDecryptMethod;
    if ((getDecryptMethod = EncryptionGrpc.getDecryptMethod) == null) {
      synchronized (EncryptionGrpc.class) {
        if ((getDecryptMethod = EncryptionGrpc.getDecryptMethod) == null) {
          EncryptionGrpc.getDecryptMethod = getDecryptMethod =
              io.grpc.MethodDescriptor.<service.DecryptRequest, service.DecryptResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "decrypt"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  service.DecryptRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  service.DecryptResponse.getDefaultInstance()))
  ...
  public static abstract class EncryptionImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void encrypt(service.EncryptRequest request,
        io.grpc.stub.StreamObserver<service.EncryptResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getEncryptMethod(), responseObserver);
    }

    /**
     */
    public void decrypt(service.DecryptRequest request,
        io.grpc.stub.StreamObserver<service.DecryptResponse> responseObserver) {
  ...
  public static final class EncryptionBlockingStub extends io.grpc.stub.AbstractBlockingStub<EncryptionBlockingStub> {
    ...
    /**
     */
    public service.EncryptResponse encrypt(service.EncryptRequest request) {
    ...
    /**
     */
    public service.DecryptResponse decrypt(service.DecryptRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class EncryptionFutureStub extends io.grpc.stub.AbstractFutureStub<EncryptionFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<service.EncryptResponse> encrypt(
        service.EncryptRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<service.DecryptResponse> decrypt(
        service.DecryptRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ENCRYPT:
          serviceImpl.encrypt((service.EncryptRequest) request,
              (io.grpc.stub.StreamObserver<service.EncryptResponse>) responseObserver);
          break;
        case METHODID_DECRYPT:
          serviceImpl.decrypt((service.DecryptRequest) request,
              (io.grpc.stub.StreamObserver<service.DecryptResponse>) responseObserver);
          break;
        default:
